...
<div id="primary" class="content-area">
    <main id="main" class="site-main" role="main">
        <article id="post-<?php the_ID(); ?>" <?php post_class("template-author clear-bottom"); ?>>
...
<div id="single-agent-row1">
    ...
    <div id="single-agent-text1">
        ...
        <?php if ($phone != '') {
?><div><?php echo $phone; ?> office</div><?php
} ?> 
        <?php if ($phone2 != '') {
?><div><?php echo $phone2; ?> cell</div><?php
} ?> 
...
<div id="single-agent-row3">
    ...
    <div class="flexslider3">
            ...
            <ul class="slides">
        <?php while (have_rows('testimonials', 'user_'.$author_id)) :
            the_row();
...
<div id="single-agent-row4">
 ...
 <!-- -->
    ...
    <div class="flexslider4">
            ...
            <ul class="slides">
        <?php while (have_rows('personal_photos', 'user_'.$author_id)) :
            the_row();
